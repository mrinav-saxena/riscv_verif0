...
class alignas(VL_CACHE_LINE_BYTES) Vtb___024root final : public VerilatedModule {
  public:
    ...
    VlUnpacked<CData/*0:0*/, 1024> tb__DOT__i_dcache__DOT__valid;
    VlUnpacked<CData/*0:0*/, 1024> tb__DOT__i_dcache__DOT__dirty;
    VlUnpacked<IData/*19:0*/, 1024> tb__DOT__i_dcache__DOT__tag;
